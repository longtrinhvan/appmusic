...
<head>
  ...
  <!-- css -->
  <link href="<c:url value='/template/login/css/home.css' />" rel="stylesheet" type="text/css" media="all" />
  <link href="<c:url value='/template/common/all.min.css' />" rel="stylesheet" type="text/css" media="all" />
...
<body>
  ...
  <div class="center">
    ...
    <div class="center-mm2">
      <div class="img">
        <iframe src="https://drive.google.com/file/d/1ZnebNtmtX9cIFOYbEgNkyy0cCEhQEzJA/preview" width="270" height="270"
          id="imageiframe"></iframe>
      </div>
      <div class="audio">
        <iframe src="https://drive.google.com/file/d/1e7gszNEnC1T_LRMUkZYdf0DmX7hiWvCI/preview" width="470" height="60"
          id="audio"></iframe>
      </div>
      <div class="detail">
        <label>Album</label>
        ...
        <div class="id_100">
	        <label>Category Music</label>
	        <select name="categorymusic" id="categorymusic">
	    
	        </select>
        </div>
        <label>Name</label> <input type="text" id="name"> <label>Url</label>
        <input type="text" id="url"> <label>Image</label> <input type="text" id="image"> <input type="hidden" id="id">
  ...
  <script>
    (function () {
      ...
      $.getJSON("http://localhost:8080/apicategory/getallcategory",
        {
          format: "json"
        })
      .done(
        function (data) {
          ...
          for (var i = 0; i < len; i++) {
            ...
            trHTML += "<option value=" + idcategory + "value" +">"+ namecategory + "</option>" ;    
          }
    ...
    $('.center-mm1').on(
      ...
      function (e) {
        ...
        $.getJSON(url, {
          ...
          $("div.id_100 select").val(data['category'].idcategory+"value");
        });
      });
