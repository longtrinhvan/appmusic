...
<body>
	...
	<div class="center">
		...
		<div class="center-mm2">
			...
			<div class="detail">
				<div id="dixname">
					<label>User</label> <input type="text" id="namex">
				</div>
				<div class="divurl">
				...
				<input type="hidden" id="id"> <input type="hidden"
					...
					id="idalbummusic"> <input type="hidden" id="page"><input
					type="hidden" id="passwordaccount">
	...
	<script>
		...
		function edit(name) {
			alert();
			var url = "http://localhost:8080/apiaccount/getaccount?name="
					+ name;
			$.getJSON(url, {
				format : "json"
			}).done(function(data) {
				...
				$("div.id_100 select").val("value" + data['role'].idrole);
				$('#passwordaccount').val(data['password']);
			});
		};
